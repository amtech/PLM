...
class Auth extends MX_Controller {
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			{
                // branch wise user
                $this->ion_auth->updateBranch($this->input->post('identity'));
	...
	function deactivate($id = NULL)
	{
		...
		{
			//redirect them to the home page because they must be an administrator to view this
			$this->session->set_flashdata('success','You must be an administrator.');
		...
		if ($this->form_validation->run() == FALSE)
		{
            ...
            $data['page_title'] = "Deactivate";
            $meta['page_title'] = "Deactivate";
			$this->load->view('commons/header',$meta);
	...
	function create_user()
	{
		...
		else
		{
            ...
            $meta['page_title'] = 'Create User | PLM System';
            $data['page_title'] = "Create User";
            $data['branch'] = $this->ion_auth->getBranch();
			$this->load->view('commons/header',$meta);
	...
	function edit_user($id)
	{
		...
		$meta['page_title'] = 'Edit User | PLM System';
	...
	function create_group()
	{
		...
		else
		{
            ...
            $meta['page_title'] = 'VRS | Create Group';
	...
	function edit_group($id)
	{
        ...
        $meta['page_title'] = 'VRS | Edit Group';
