...
<head>
  ...
  <title><?php echo "Users | PLM System";?></title>
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo" style="background-color:#fff">
            <a href="index.html"><img src="<?php echo base_url(); ?>assets/uploads/logo/logo.png" width="200px" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-star"></i> <span>Purchases</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="<?php echo base_url(); ?>index.php/purchases/parts"> Parts</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-star"></i> <span>Sales</span></a>
                    <ul class="sub-menu-list">
                ...
                <li class="menu-list"><a href="#"><i class="fa fa-star"></i> <span>Transactions</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="<?php echo base_url(); ?>index.php/reciepts"> Reciepts</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/payments"> Payments</a></li>
                    </ul>
                </li>
                <li class="menu-list"><a href="#"><i class="fa fa-user"></i> <span>People</span></a>
                    <ul class="sub-menu-list">
