            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="wdgt-profile">
                        <div class="profile">
                            <img src="<?php echo base_url(); ?>assets/images/gallery/wdgt-img.jpg" alt=""/>
                ...
                <div class="col-md-4">
                    <div class="panel widget-info-one">
                        <div class="avatar-img">
                            <img src="<?php echo base_url(); ?>assets/images/gallery/image3.jpg" alt=""/>
                        </div>
                        <div class="inner">
                            <div class="avatar"><img alt="" src="<?php echo base_url(); ?>assets/images/photos/userprofile.png"></div>
                            <h5>Margarita Rose</h5>
                            <span class="subtitle">
                        ...
                        <div class="panel-body">
                            <div class="dir-info">
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="<?php echo base_url(); ?>assets/images/photos/user3.png" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Bit it</h5>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="<?php echo base_url(); ?>assets/images/photos/user4.png" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Its my life</h5>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="chats cool-chat">
                                <li class="in">
                                    <img src="<?php echo base_url(); ?>assets/images/photos/user1.png" alt="" class="avatar">
                                    <div class="message">
                                ...
                                <li class="out">
                                    <img src="<?php echo base_url(); ?>assets/images/photos/user2.png" alt="" class="avatar">
                                    <div class="message">
                                        <span class="arrow"></span>
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="<?php echo base_url(); ?>assets/images/photos/user2.png" alt=""/>
                                </a>
        ...
        <ul class="dash">
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/parts" title="Inventory" data-toggle="tooltip">
                    <i>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/purchases/parts" title="Purchase" data-toggle="tooltip">
                    <i>
                        <img src="<?php echo base_url(); ?>assets/img/puchase.png" />
                    </i>
                    <span>
                        <span>Purchase</span>
                    </span>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/sales/parts" title="Sales Order" data-toggle="tooltip">
                    <i>
                        <img src="<?php echo base_url(); ?>assets/img/sales.png" />
                    </i>
                    <span>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/quotations" title="Quotation" data-toggle="tooltip">
                    <i>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/records" title="Records" data-toggle="tooltip">
                    <i>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/products" title="Reference Equipments" data-toggle="tooltip">
                    <i>
                        <img src="<?php echo base_url(); ?>assets/img/equipments.png" />
                    </i>
                    <span>
                        <span>Reference Equipments</span>
                    </span>
                </a>
            </li>
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/reports/inventory" title="Reports" data-toggle="tooltip">
                    <i>
            ...
            <li>
                <a class="tip" href="<?php echo base_url(); ?>index.php/settings" title="Settings" data-toggle="tooltip">
                    <i>
