                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="add">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_of_issue" placeholder="Select Date of issue" value="<?php echo set_value('date_issue'); ?>" name="date_issue" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="date_in_cheque">Date in Cheque <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_in_cheque" placeholder="Select Date in Cheque" value="<?php echo set_value('date_cheque'); ?>" name="date_cheque" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="cheque_no">Cheque No <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Cheque No" id="cheque_no" value="<?php echo set_value('cheque_no'); ?>" name="cheque_no">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="bank_ref">Bank Ref.</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Bank Ref." id="bank_ref" value="<?php echo set_value('bank_ref'); ?>" name="bank_ref">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="party_favouring">Party Favouring</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Party Favouring" id="party_favouring" value="<?php echo set_value('party_favouring'); ?>" name="party_favouring">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="reason">Reason</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Reason" id="reason" value="<?php echo set_value('reason'); ?>" name="reason">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="cheque_amount">Cheque Amount <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Cheque Amount" id="cheque_amount" value="<?php echo set_value('amount'); ?>" name="amount">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="bank_acc_no">Bank Account No <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Bank Account No" id="bank_acc_no" value="<?php echo set_value('bank_account_no'); ?>" name="bank_account_no">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="payment_from">Payment From Date</label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="payment_from" placeholder="Select payment from date" value="<?php echo set_value('payment_from'); ?>" name="payment_from_date"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="payment_to">Payment To Date</label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="payment_to" placeholder="Select payment to date" value="<?php echo set_value('payment_to'); ?>" name="payment_to_date" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="panel-body">
                                <p>
