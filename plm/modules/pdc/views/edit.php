                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="../edit/<?php echo $id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_of_issue" placeholder="Select Date of issue" value="<?php echo date('d/m/Y',strtotime($pdc->date_issue)); ?>" name="date_issue" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="date_in_cheque">Date in Cheque <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="date_in_cheque" placeholder="Select Date in Cheque" value="<?php echo date('d/m/Y',strtotime($pdc->date_cheque)); ?>" name="date_cheque" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="payment_from" placeholder="Select payment from date" value="<?php echo date('d/m/Y',strtotime($pdc->payment_from_date)); ?>" name="payment_from_date"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 col-sm-3 control-label" for="payment_to">Payment To Date</label>
                                <div class="col-lg-9">
                                    <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" id="payment_to" placeholder="Select payment to date" value="<?php echo date('d/m/Y',strtotime($pdc->payment_to_date)); ?>" name="payment_to_date" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="panel-body">
                                <p>
