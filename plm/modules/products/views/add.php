            ...
            <div class="col-lg-6">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/products/add" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('brand_id',$optionBrand,isset($_POST['brand_id'])?$_POST['brand_id']:'','style="width:40%" class="form-control chosen-select"');
                                ?>                                
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('category_id',$optionCat,isset($_POST['category_id'])?$_POST['category_id']:'','style="width:40%;" class="form-control chosen-select" id="category"');
                                ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('sub_category_id',$optionSubCat,isset($_POST['sub_category_id'])?$_POST['sub_category_id']:'','style="width:40%;" class="form-control chosen-select" id="sub_category"');
                                ?>
                                </div>
                            </div>
							<!--<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="model_name" placeholder="Model Name" name="model_name" value="<?php echo set_value('model_name'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
