                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/quotations/add" method="post" id="quotation_form">
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input class="form-control form-control-inline input-medium default-date-picker" type="text" id="expected_del_time" placeholder="Expected Delivery Time" name="expected_del_time" value="<?php echo set_value('expected_del_time',date('d/m/Y')); ?>" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" id="charges" name="charges" class="form-control" value="<?php echo set_value('charges'); ?>" onkeyup="calculateSubTotal(this);" />
                                </div>
