        ...
        <script>
            $(document).ready(function(){
                $('#record_id').change(function(){
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?php echo base_url(); ?>index.php/records/getTechnician",
                        cache: false,               
                        ...
                        success: function(result){
                            try{
                                ...
                                console.log(data);
                                $('#technician_id').val(data[0].technician_name);
                                $('#technician_name').val(data[0].technician_name);
                            }catch(e) {      
            ...
            <div class="col-lg-6">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/records/add_commission" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="date" class="col-lg-3  control-label">Date</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="date" placeholder="Comission Date" name="date" value="<?php echo set_value('date',date('d/m/Y')); ?>" autocomplete="off" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('record_id',$optionRC,isset($_POST['record_id'])?$_POST['record_id']:'','class="form-control chosen-select" id="record_id"');
                                ?>
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="technician_id" placeholder="Technician Name" name="technician_name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="report_no" placeholder="Report No" name="report_no" value="<?php echo set_value('report_no'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="file" name="commission_report" id="commissioning_report" accept="image/*" />
                                </div>
                            </div>
