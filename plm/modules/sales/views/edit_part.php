                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/sales/edit_part/<?php echo $id; ?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="date" placeholder="Sale Part Date" name="date" value="<?php echo set_value('date',date('d/m/Y',strtotime($sale_part[0]->date))); ?>">
                                </div>
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('warehouse_id',$optionWr,isset($_POST['warehouse_id'])?$_POST['warehouse_id']:$sale_part[0]->warehouse_id,'class="form-control chosen-select" id="warehouse_id"');
                                ?>
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="po_no" placeholder="Client PO NO" value="<?php echo set_value('po_no',$sale_part[0]->po_no); ?>" name="po_no">
                                </div>
                                
                                <label for="quotation_no" class="col-sm-2 control-label col-lg-2">Quotation NO</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="quotation_no" placeholder="Quotation NO" name="quotation_no" value="<?php echo set_value('quotation_no',$sale_part[0]->quotation_no); ?>">
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="payment_terms" placeholder="Payment Terms" name="payment_terms" value="<?php echo set_value('payment_terms',$sale_part[0]->payment_terms); ?>">
                                </div>
                                
                                <label for="ship_date" class="col-sm-2 control-label col-lg-2">Ship Date</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="ship_date" placeholder="Ship Date" value="<?php echo set_value('ship_date',date('d/m/Y',strtotime($sale_part[0]->ship_date))); ?>" name="ship_date" autocomplete="off" >
                                </div>
							...
							<div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('customer_id',$optionCust,isset($_POST['customer_id'])?$_POST['customer_id']:$sale_part[0]->customer_id,'class="form-control chosen-select" id="customer_id"');
                                ?>
                                </div>
                                
                                <label for="ship_to" class="col-sm-2 control-label col-lg-2">Ship To</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="ship_to" placeholder="Ship To" name="ship_to" value="<?php echo set_value('ship_to',$sale_part[0]->ship_to); ?>">
                                </div>
							...
							<div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('ship_via',$optionShip,isset($_POST['ship_via'])?$_POST['ship_via']:$sale_part[0]->ship_via,'class="form-control" id="ship_via"');
                                ?>
                                </div>
                                
                                <label for="delivery" class="col-sm-2 control-label col-lg-2">Delivery Instruction</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" id="delivery" placeholder="Delivery Instruction" name="delivery" value="<?php echo set_value('delivery',$sale_part[0]->delivery); ?>">
                                </div>
							...
							<div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('discount',$optionDisc,isset($_POST['discount'])?$_POST['discount']:$sale_part[0]->discount,'class="form-control" id="discount" onchange="calculateSubTotal(this);"');
                                ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    echo form_dropdown('status',$optionStat,isset($_POST['status'])?$_POST['status']:$sale_part[0]->status,'class="form-control" id="status"');
                                ?>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <tbody>	
                                        ...
                                        <tr id="<?php echo $count++; ?>">
                                            ...
                                            <?php
                                                ...
                                                $part_count = $count-1;
                                                echo form_dropdown("parts_id$part_count",$optionPart1,$row->part_id,'class="form-control chosen-select" id="parts_id-'.$part_count.'" onchange="getParts(this);"');
                                            ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Quantity" id="quantity-<?php echo ($count-1); ?>" name="quantity<?php echo ($count-1); ?>" onkeyup="calculateSubTotal(this);" value="<?php echo $row->quantity; ?>" >
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" placeholder="Price" id="price-<?php echo ($count-1); ?>" name="price<?php echo ($count-1); ?>" onkeyup="calculateSubTotal(this);" value="<?php echo $row->price; ?>">
                                            </td>
                                            <td>
                                                <select class="form-control" id="item_received-<?php echo ($count-1); ?>" name="item_received<?php echo ($count-1); ?>">
                                                    <option value="0">-- Select --</option>
