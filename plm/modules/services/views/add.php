        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/services/add" method="post" enctype="multipart/form-data" id="service_form">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input class="form-control form-control-inline input-medium default-date-picker" type="text" id="service_date" placeholder="Select Quotation Date" name="service_date" value="<?php echo set_value('service_date',date('d/m/Y')); ?>" autocomplete="off" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" name="working_hour" id="working_hour" value="<?php echo set_value('working_hour') ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="technician_name" id="technician_id" value="<?php echo set_value('technician_name'); ?>" class="form-control" placeholder="Technician Name" />
                                <span id="error_technician"></span>
                            </div>
                            
                            <label for="service_report_no" class="col-sm-2 control-label col-lg-2">Service Report No</label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="service_report_no" name="service_report_no" value="<?php echo set_value('service_report_no') ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select class="form-control" name="job_status" id="job_status">
                                    <option value="yes" <?php if(isset($_POST['job_status']) && $_POST['job_status']=='yes'){ ?>selected <?php } ?>>Completed</option>
                                    <option value="no" <?php if(isset($_POST['job_status']) && $_POST['job_status'] == 'no'){ ?>selected <?php } ?>>Pending</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="file" name="service_report" id="service_report" accept="image/*" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="parts_charge" id="parts_charge" class="form-control" disabled />
                            </div>
                            
                            <label for="service_charge" class="col-sm-2 control-label col-lg-2">Service Charge</label>
                            <div class="col-lg-4">
                                <input type="text" name="service_charge" id="service_charge" class="form-control" value="0" onkeyup="(calculateTotal(this.value))"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="total_charge" class="col-sm-2 control-label col-lg-2">Total Charge</label>
                            <div class="col-lg-4">
                                <input type="text" name="total_charge" id="total_charge" class="form-control" disabled />
                            </div>
                        </div>
                    </div>
                </section>
                <section class="panel" id="part_detail" style="display:none;">
                    <header class="panel-heading">
                        Part Details
                    </header>
                    <div class="panel-body">
                            ...
                            <table class="table" id="myTable">
                                <tbody>
                                    ...
                                    <tr id="1">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" placeholder="0" id="quantity-1" name="quantity1" onkeyup="calculateSubTotal(this);" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="0.00" id="price-1" name="price1" onkeyup="calculateSubTotal(this);" disabled>
                                        </td>
                                        <td>
                                            <select class="form-control" name="supply_condition1" id="supply_condition-1">
                                                <option value="free" selected>Free</option>
                                                <option value="paid">Paid</option>
                                            </select>
                                        </td>    
                                        <td>
                                            <select class="form-control" name="stock_status1" id="stock_status-1">
                                                <option value="yes">Yes</option>
                                                <option value="no" selected>No</option>
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="order_date-1" name="order_date1" autocomplete="off">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="arrival_date-1" name="arrival_date1" autocomplete="off">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="delivery_date-1" name="delivery_date1" autocomplete="off">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" id="description-1" name="description1" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control sub_total" placeholder="0.00" id="grand_total-1" name="grand_total1" disabled>
                                        </td>
                                        <td></td>
                        ...
                        <input type="hidden" name="parts_total" id="parts_total" />
                        <input type="hidden" name="total" id="total" />
                    </div>
                </section>
                <section class="panel" id="remark_div" style="display:none;">
                    <header class="panel-heading">
                        Remarks
                    </header>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div style="padding:10px;">
                                <textarea class="form-control" name="editor1" rows="6" id="remarks"></textarea>
                            </div>
                        </div>
                    </div>
                </section>
