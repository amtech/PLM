        ...
        <script type="text/javascript">
                ...
                $('#add').click(function(){
                    ...
                    $('#myTable tr:last').after(
                        '<tr id='+count+'>'+
                            ...
                            '</td>'+
                            '<td>'+
                                '<input type="text" class="form-control datepicker_recurring_start" id="order_date-'+count+'" name="order_date'+count+'" >'+
                            '</td>'+
                            '<td>'+
                                '<input type="text" class="form-control datepicker_recurring_start" id="arrival_date-'+count+'" name="arrival_date'+count+'">'+
                            '</td>'+
                            '<td>'+
                                '<input type="text" class="form-control datepicker_recurring_start" id="delivery_date-'+count+'" name="delivery_date'+count+'">'+
                            '</td>'+
                            '<td>'+
            ...
            function calculateSubTotal(object){
                ...
                if(condition == 'paid'){
                    ...
                    $("#parts_charge").val(0.00);
                    $("#parts_total").val(0.00);
                    var service = $('#service_charge').val();
                    var total_charge = parseFloat(0.00) + parseFloat(service);
                    $('#total_charge').val(total_charge);
                    $('#total').val(total_charge);
                }
            }
        ...
        <div class="row">
            <div class="col-lg-12">
                <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/services/edit" method="post">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <?php
                                ...
                                echo form_dropdown('record_id',$optionRecord,isset($_POST['record_id'])?$_POST['record_id']:$services[0]->record_id,'class="form-control chosen-select" id="record_id" disabled');
                            ?>  
                            </div>
                            <label for="service_date" class="col-sm-2 control-label col-lg-2">Service Date</label>
                            <div class="col-lg-4">
                                <input class="form-control form-control-inline input-medium default-date-picker" type="text" id="service_date" placeholder="Select Quotation Date" name="service_date" value="<?php echo set_value('service_date',date('d/m/Y',strtotime($services[0]->service_date))); ?>" disabled />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" name="working_hour" id="working_hour" value="<?php echo set_value('working_hour',$services[0]->working_hour) ?>" disabled />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="technician_id" class="col-sm-2 control-label col-lg-2">Technician</label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" name="technician_name" id="technician_id" value="<?php echo $services[0]->technician_name; ?>" disabled />
                            </div>
                            
                            <label for="service_report_no" class="col-sm-2 control-label col-lg-2">Service Report No</label>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" id="service_report_no" name="service_report_no" value="<?php echo set_value('service_report_no',$services[0]->service_report_no) ?>" disabled />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select class="form-control" name="job_status" id="job_status" disabled>
                                    <option value="yes" <?php if($services[0]->job_status == 'yes'){ ?>selected <?php } ?>>Yes</option>
                                    <option value="no" <?php if($services[0]->job_status == 'no'){ ?>selected <?php } ?>>No</option>
                                </select>
                            </div>
                            
                            <label for="remark_note" class="col-sm-2 control-label col-lg-2">Remark Note</label>
                            <div class="col-lg-4">
                                <select class="form-control" name="remark_note" id="remark_note" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select class="form-control" name="part_needed" id="part_needed" disabled>
                            ...
                            <div class="col-lg-4">
                                <img src="<?php echo base_url(); ?>assets/uploads/services/<?php echo $services[0]->service_report; ?>" width="50px;"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="service_charge" id="service_charge" class="form-control" value="<?php echo $services[0]->service_charge; ?>" onkeyup="(calculateTotal(this.value))" disabled />
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?php echo $count++; ?>">
                                        ...
                                        <?php
                                            ...
                                            if(!empty($parts)){
                                                foreach($parts as $rowParts){
                                                    $optionParts[$rowParts->id] = $rowParts->name;
                                                }
                                            }
                                            $part_id = $count-1;
                                            echo form_dropdown("parts_id$part_id",$optionParts,$row->part_id,'class="form-control" id="parts_id-'.$part_id.'" onchange="getParts(this);" disabled');
                                        ?>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="0" id="quantity-<?php echo ($count-1); ?>" name="quantity<?php echo ($count-1); ?>" value="<?php echo $row->quantity; ?>" onkeyup="calculateSubTotal(this);" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="0.00" id="price-<?php echo ($count-1); ?>" name="price<?php echo ($count-1); ?>" onkeyup="calculateSubTotal(this);" value="<?php echo $row->price; ?>" disabled>
                                        </td>
                                        <td>
                                            <select class="form-control" name="supply_condition<?php echo ($count-1); ?>" id="supply_condition-<?php echo ($count-1); ?>" disabled>
                                        ...
                                        <td>
                                            <select class="form-control" name="stock_status<?php echo ($count-1); ?>" id="stock_status-<?php echo ($count-1); ?>" disabled>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="order_date-<?php echo ($count-1); ?>" name="order_date<?php echo ($count-1); ?>" value="<?php echo date('d/m/Y',strtotime($row->order_date)); ?>" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="arrival_date-<?php echo ($count-1); ?>" name="arrival_date<?php echo ($count-1); ?>" value="<?php echo date('d/m/Y',strtotime($row->estimate_arrival_date)); ?>" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-inline input-medium default-date-picker" id="delivery_date-<?php echo ($count-1); ?>" name="delivery_date<?php echo ($count-1); ?>" value="<?php echo date('d/m/Y',strtotime($row->delivery_date)); ?>" disabled>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" id="description-<?php echo ($count-1); ?>" name="description<?php echo ($count-1); ?>" value="<?php echo $row->description;?>" disabled>
                                        </td>
                                        <td>
