...
class Vehicleowner extends CI_Controller 
{
    ...
    function index()
    {
        ...
        $meta['page_title'] = 'Owner Details';
		$data['page_title'] = "Owner details";
    ...
    function view($owner_id)
    {
        ...
        $meta['page_title'] = 'View Owner | PLM System';
        $data['page_title'] = "View Owner";
        $this->load->view('commons/header', $meta);
    ...
    function add()
    {
		...
		{  
		    ...
		    $meta['page_title'] = 'Add Owner';
            $data['page_title'] = "Add Owner";
            $this->load->view('commons/header', $meta);
    ...
    public function edit($owner_id)
    {
        ...
        if($post = $this->input->post())
        {
            ...
            {  
                ...
                $meta['page_title'] = 'Edit Owner';
                $data['page_title'] = "Edit Owner";
                $this->load->view('commons/header', $meta);
