                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="add">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Company Abbreviation" id="txt_owner_company_abb" name="company_abbrev" value="<?php echo set_value("company_abbrev"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="txt_owner_company">Company Name <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Company Name" id="txt_owner_company" name="company_name" value="<?php echo set_value("company_name"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="txt_owner_name">Name <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Owner Name" id="txt_owner_name" name="name" value="<?php echo set_value("name"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="txt_owner_mobile">Mobile No</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Mobile No" id="txt_owner_mobile" name="mobile_no" value="<?php echo set_value("mobile_no"); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-lg-3 col-sm-3 control-label" for="txt_email">Email <span style="color:red;">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Email Id" id="txt_email" name="email" value="<?php echo set_value("email"); ?>">
                                </div>
                            </div>
                            <div class="panel-body">
                                <p>
