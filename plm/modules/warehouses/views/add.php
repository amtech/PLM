            ...
            <div class="col-lg-6">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/warehouses/add">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="warehouse_name" placeholder="Warehouse Name" name="warehouse_name" value="<?php echo set_value('warehouse_name'); ?>">
                                </div>
                            </div>
							<div class="form-group">
                                <label for="warehouse_desc" class="col-lg-3  control-label">Warehouse Description</label>
                                <div class="col-lg-9">
                                    <textarea id="warehouse_desc" class="form-control" name="warehouse_desc"><?php echo set_value('warehouse_desc'); ?></textarea>
                                </div>
                            </div>
							<div class="panel-body">
                                <p>
